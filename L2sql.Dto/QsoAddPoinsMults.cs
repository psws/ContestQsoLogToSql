...
namespace L2Sql.Dto
{
    public class QsoAddPoinsMultsDTO
    {
    ...
    public class QsoUpdatePoinsMultsDTO
    {
        public short QsoNo { get; set; }
        public int LogId { get; set; }
    ...
    public class QsoUpdatePoinsMultsDTOCollextion : List<QsoUpdatePoinsMultsDTO>, IEnumerable<SqlDataRecord>
    {
        IEnumerator<SqlDataRecord> IEnumerable<SqlDataRecord>.GetEnumerator()
        {
            ...
            foreach (QsoUpdatePoinsMultsDTO qupmd in this)
            {
